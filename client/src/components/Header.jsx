  ...
  <header className="bg-gradient-to-r from-blue-600 to-blue-400 p-6 shadow-lg">
    <div className="container mx-auto flex justify-between items-center">
      ...
      <nav className="flex items-center space-x-6">
        ...
        <button className="bg-white text-blue-600 px-6 py-2 rounded-full shadow-md hover:bg-gray-100 transition duration-300 transform hover:scale-105 hover:-translate-y-1">
          DAFTAR
        </button>
      </nav>
    </div>
